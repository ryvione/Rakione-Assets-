...
local CustomImageManagerAssets = {
    TransparencyTexture = {
        ...
        Path = "Rakione/assets/TransparencyTexture.png",
    ...
    SaturationMap = {
        RobloxId = 4155801252,
        Path = "Rakione/assets/SaturationMap.png",
...
do
    ...
    function CustomImageManager.AddAsset(AssetName: string, RobloxAssetId: number, URL: string, ForceRedownload: boolean?)
        ...
        CustomImageManagerAssets[AssetName] = {
            ...
            Path = string.format("Rakione/custom_assets/%s", AssetName),
            URL = URL,
...
local Library = {
    ...
    GlowTweenInfo = TweenInfo.new(0.5, Enum.EasingStyle.Sine, Enum.EasingDirection.InOut),
    ...
    Scheme = {
        ...
        AccentColorSecondary = Color3.fromRGB(255, 180, 50),
        AccentGradientStart = Color3.fromRGB(255, 120, 0),
        AccentGradientEnd = Color3.fromRGB(255, 200, 80),
...
--// Unique Cursor Design - Orange Crosshair with Glow
local Cursor
do
    Cursor = New("Frame", {
    ...
    New("UICorner", { CornerRadius = UDim.new(0, 1), Parent = CursorH })
    ...
    New("UICorner", { CornerRadius = UDim.new(0, 1), Parent = CursorV })
    ...
    local GlowStroke2 = New("UIStroke", {
        Color = "AccentColor",
        Thickness = 3,
        Transparency = 0.6,
        Parent = CursorV,
...
function Library:AddOutline(Frame: GuiObject)
    -- Unique glow effect with gradient-like appearance
    local GlowStroke = New("UIStroke", {
        Color = "OutlineGlow",
        Thickness = 2,
        Transparency = 0.7,
...
function Library:AddGlowEffect(Frame: GuiObject, Intensity: number?)
   ...
   local GlowGradient = New("UIGradient", {
    ...
    task.spawn(function()
        while Glow and Glow.Parent do
            local time = tick()
            GlowGradient.Rotation = 45 + math.sin(time) * 15
            task.wait(0.05)
        end
    end)
...
function Library:MakeOutline(Frame: GuiObject, Corner: number?, ZIndex: number?)
	warn("Rakione:MakeOutline is deprecated, please use Rakione:AddOutline instead.")
